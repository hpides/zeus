...
public class LocalGeneratorTest {
    ...
    // final ListSource<Integer> source = new ListSource<>(listS1, new
    // WatermarkGenerator<>(-1, -1), e -> e);
    // AStream<Integer> aStream = builder.streamOf(source);
    // FilterGenerator<Integer> filter = new FilterGenerator<Integer>("element % 4
    // == 0");
    // UnaryGenerationNode<Integer, Integer> node = new UnaryGenerationNode<Integer,
    // Integer>(filter);
