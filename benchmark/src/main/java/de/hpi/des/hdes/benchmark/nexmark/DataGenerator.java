...
public class DataGenerator {
  ...
  public final int NUM_FIRSTNAMES;
  public final int NUM_LASTNAMES;
  public Random rnd = new Random(42);

  public DataGenerator() {
    try {
      firstnames = Files.readAllLines(
          Paths.get(
              DataGenerator.class.getClassLoader().getResource("firstnames.txt").toURI()));
      lastnames = Files.readAllLines(
          Paths.get(
              DataGenerator.class.getClassLoader().getResource("lastnames.txt").toURI()));
    } catch (IOException | URISyntaxException e) {
      e.printStackTrace();
    }
    NUM_FIRSTNAMES = DataGenerator.firstnames.size();
    NUM_LASTNAMES = DataGenerator.lastnames.size();

  }

  public String getRandomFirstName() {
    return DataGenerator.firstnames.get(this.rnd.nextInt(NUM_FIRSTNAMES));
  }

  public String getRandomLastName() {
    return DataGenerator.lastnames.get(this.rnd.nextInt(NUM_LASTNAMES));
  }

  public String getRandomEmail() {
    return DataGenerator.emails[this.rnd.nextInt(NUM_EMAILS)];
  }

  public String getRandomEducation() {
    return DataGenerator.education[this.rnd.nextInt(NUM_EDUCATION)];
  }

  public String getRandomCountry() {
    return DataGenerator.countries[this.rnd.nextInt(NUM_COUNTRIES)];
  }

  public String getRandomProvinces() {
    return DataGenerator.provinces[this.rnd.nextInt(NUM_PROVINCES)];
  }

  public String getRandomCity() {
    return DataGenerator.cities[this.rnd.nextInt(NUM_CITIES)];
  }
}
